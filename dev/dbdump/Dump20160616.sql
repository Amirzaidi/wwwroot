...
--
-- Machine: localhost
-- Genereertijd: 16 jun 2016 om 16:03
-- Serverversie: 5.6.13
-- PHP-versie: 5.4.17
...
(1, 'China', 'The best country to fabricate stuff!', 'active', 0, 5),
...
(12, 'Iran', 'The country where nothing is allowed, but everything still happens', 'active', 1, 5),
...
('clearvotes', 5, 1466092815),
('pickrandom', 30, 1466092800);
...
(71, 'Tavuk gö&#287;sü', 'The signature Ottoman treat is tavuk gö&#287;sü, or chicken breast pudding. It’s a strange blend of boiled chicken, milk, and sugar, dusted with cinnamon. And it’s delicious. Look for it on menus across the country.', 14),
